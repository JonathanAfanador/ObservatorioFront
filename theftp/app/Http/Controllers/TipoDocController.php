...
class TipoDocController extends Controller
{
    ...
    {
        parent::__construct(new TipoDocumento(), Tablas::TIPO_DOC);
    }
     ...
     * )
     */
    public function store(StoreTipoDocRequest $request)
    {
     ...
     * )
     */
    public function edit(string $id, UpdateTipoDocRequest $request)
    {
