...
class Documento extends Model implements Auditable
{
    ...
    */
    ...
    public function tipo_documento(){
        return $this->belongsTo(TipoDocumento::class, 'tipo_doc_id'); // Relación con el modelo tipos_documentos
    
    }

    // Función para definir la relación con el modelo empresas
    public function empresa(){
        return $this->belongsTo(Empresa::class, 'empresa_id'); // Relación con el modelo empresas
    }
}
