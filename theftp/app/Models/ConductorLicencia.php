 ...
 * )
 */
class ConductorLicencia extends Model implements Auditable
{
    ...
    */
    ...
    public function conductor(){
        return $this->belongsTo(Conductor::class, 'conductor_id'); // Relación con el modelo conductores
    }

    // Función para definir la relación con el modelo licencias
    public function licencia(){
        return $this->belongsTo(Licencia::class, 'licencia_id'); // Relación con el modelo licencias
    }
}
