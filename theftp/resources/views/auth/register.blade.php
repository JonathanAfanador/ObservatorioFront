        ...
        <form id="register-form" novalidate>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3">
                ...
                <div class="form-group">
                    ...
                    <p class="form-helper-text" id="helper-name">Ej: Juan Pablo. Máx. 2 nombres, inician con mayúscula.</p>
                ...
                <div class="form-group">
                    ...
                    <p class="form-helper-text" id="helper-last_name">Ej: Medina Ortíz. Máx. 2 apellidos, inician con mayúscula.</p>
                ...
                <div class="form-group">
                    ...
                    <p class="form-helper-text" id="helper-nui">La longitud depende del tipo de documento (ej. C.C. 7-10 dígitos).</p>
                ...
                <div class="form-group">
                    ...
                    <p class="form-helper-text" id="helper-phone_number">Debe tener 10 dígitos. Ej: 3101234567</p>
                ...
                <div class="form-group">
                    ...
                    <p class="form-helper-text" id="helper-password">Mín. 8 caracteres, 3/4 tipos (Mayús, minús, núm, símbolo).</p>
