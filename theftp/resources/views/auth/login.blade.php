<x-layouts.guest>
    ...
    <div class="auth-card w-full max-w-md">
        ...
        {{-- Logos institucionales que aparecen en la parte superior --}}
        ...
        {{-- Caja de alerta que se muestra cuando el usuario cierra sesión --}}
        ...
        {{-- Contenedores para mensajes dinámicos desde JS (errores o éxito) --}}
